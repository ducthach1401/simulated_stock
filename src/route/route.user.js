...
router
  ...
  .put(
    commonValidateBody(schemaValidate.updateUserSchema),
    controller.updateUser
  );

router.route("/all").all(authenticateToken).get(controller.getAllUser);
...
router
  ...
  .delete(
    commonValidateBody(schemaValidate.sellstockSchema),
...
router
  .route("/register")
  .post(
    commonValidateBody(schemaValidate.createUserSchema),
...
router.route("/refresh").all(authenticateToken).get(controller.refresh);

router.route("/stocks").all(authenticateToken).get(controller.getAllStock);

router
  .route("/password")
  .all(authenticateToken)
  .put(
    commonValidateBody(schemaValidate.updatePasswordSchema),
    controller.updateUser
  );
